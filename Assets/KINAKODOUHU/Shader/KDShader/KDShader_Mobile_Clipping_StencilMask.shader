...
//(C)KINAKODOUHU
Shader "KDShader/KDShader_Mobile_Clipping_StensilMask"
{
	Properties
	{
	  [HideInInspector]	_KDSVersion	                  ( "Version"	, Float ) = 1.00
      [HideInInspector] _KDSType                      ( "ShderType"	, Int ) = 0
		  ...
		  [ToggleUI]    _Use_BaseAsFix                ("use_BaseAsFix", Float) = 0
		  ...
		  [ToggleUI]    _ParallaxToggle               ("parallaxToggle", Float) = 0
		  ...
		  [ToggleUI]    _Anisotropic_TangentNormal_Toggle("Anisotropic_Tangent Normal_Toggle", Float) = 0
		                _aniso_offset                    ("aniso_offset", Range( -1 , 1)) = 0.5927008
		                _HighColor                       ("HighColor", Color) = (1,1,1,1)
		                _HighColor_Power                 ("highColor_Power", Range( 0 , 1)) = 0.2917107
		  [ToggleUI]    _Is_NormalMapToHighColor         ("HighColor Normal", Float) = 0
		  [ToggleUI]    _RimLightToggle                  ("RimLightToggle", Float) = 1
		...
		SubShader{
		     ...
		     Tags { "IgnoreProjector"="True" "RenderType"="TransparentCutout" "Queue"="AlphaTest" }   
		        ...
		        LOD 0
	              ...
	              Blend One Zero, SrcAlpha SrcAlpha
			...
			ENDCG
		       ...
		       Pass{
				 ...
				 #include "./cginc/KDShader_Outline.cginc"
