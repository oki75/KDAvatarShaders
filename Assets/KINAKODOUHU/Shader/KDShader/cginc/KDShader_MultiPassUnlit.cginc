...
//_Mobile
			...
			fixed4 frag ( v2f i  ) : SV_Target
			{
				...
				float4 WSLD1664_g1 = (( _Is_BLD )?( BLD2460_g1 ):( float4( LightDirection2191_g1 , 0.0 ) ));
				float4 normalizeResult1619_g1 = normalize( ( float4( ase_worldViewDir , 0.0 ) + WSLD1664_g1 ) );
				float dotResult253_g1 = dot( float4( worldNormal251_g1 , 0.0 ) , normalizeResult1619_g1 );
				float temp_output_1626_0_g1 = saturate( dotResult253_g1 );
				float temp_output_2092_0_g1 = ( 1.0 - _HighColor_Power );

				float lerpResult2096_g1 = lerp( temp_output_1626_0_g1 , pow( temp_output_1626_0_g1 , 15.0 ) , temp_output_2092_0_g1);
				...
				float temp_output_1793_0_g1 = max( 0.0 , sin( radians( ( ( (( _Anisotropic_TangentNormal_Toggle )?( dotResult1797_g1 ):( dotResult253_g1 )) + _aniso_offset ) * 180.0 ) ) ) );
				float lerpResult2097_g1 = lerp( temp_output_1793_0_g1 , pow( temp_output_1793_0_g1 , 15.0 ) , temp_output_2092_0_g1);
				...
				float lerpResult1823_g1 = lerp( lerpResult2096_g1 , lerpResult2097_g1 , ( 1.0 * (( _Anisotropic_highlight_Toggle )?( AnisotropicMask1959_g1 ):( 0.0 )) ));
           ...
           //Fixshade
			...
			//Lighting
				...
				float3 clampResult2162_g1 = clamp( ifLocalVar2141_g1 , temp_cast_5 , float3( 1,1,1 ) );
